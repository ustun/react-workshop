      ...
      React.createElement("div", null, 
          ...
          React.createElement("div", {className: "small-12 medium-8 large-6 columns"}, 
            React.createElement("div", {className: "nav-bar"}, 
              React.createElement("ul", {className: "button-group"}, 
                React.createElement("li", null, React.createElement("a", {href: "http://foundation.zurb.com/templates/portfolio-theme.html#", className: "button"}, "About")), 
                React.createElement("li", null, React.createElement("a", {href: "http://foundation.zurb.com/templates/portfolio-theme.html#", className: "button"}, "Work")), 
                React.createElement("li", null, React.createElement("a", {href: "http://foundation.zurb.com/templates/portfolio-theme.html#", className: "button"}, "Contact"))
              )
            )
          )
        ), 
        ...
        React.createElement("div", {className: "row about"}, 
          React.createElement("div", {className: "medium-6 large-8 columns"}, 
            ...
            React.createElement("p", null, "Bacon ipsum dolor sit amet nulla ham qui sint exercitation eiusmod commodo, chuck duis velit. Aute in reprehenderit, dolore aliqua non est magna in labore pig pork biltong. Eiusmod swine spare ribs reprehenderit culpa. Boudin aliqua adipisicing rump corned beef.")
          ), 
