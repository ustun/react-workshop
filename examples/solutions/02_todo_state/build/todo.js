...
var Todo = React.createClass({displayName: "Todo",
    ...
    render: function () {
        ...
        onChange: this.props.toggleItemWithName.bind(this, this.props.item.name)}), 
                ...
                React.createElement("button", {className: "destroy", onClick: this.props.removeItemWithName.bind(this, this.props.item.name)})
              ), 
        ...
        return React.createElement("footer", {id: "footer", style: {display: 'block'}}, 
          ...
          React.createElement("ul", {id: "filters"}, 
            React.createElement("li", null, 
              React.createElement("a", {className: !this.props.criteria && "selected", href: "#/", onClick: this.props.setCriteria.bind(this, null)}, "All")
            ), 
            React.createElement("li", null, 
              React.createElement("a", {className: this.props.criteria === "active" && "selected", href: "#/active", onClick: this.props.setCriteria.bind(this, "active")}, "Active")
            ), 
            React.createElement("li", null, 
              React.createElement("a", {className: this.props.criteria === "completed" && "selected", href: "#/completed", onClick: this.props.setCriteria.bind(this, "completed")}, "Completed")
            )
          )
        )
    }
