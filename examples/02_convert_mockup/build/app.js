...
var TopMenu = React.createClass({displayName: "TopMenu",
    ...
    render: function () {
       ...
       return            React.createElement("div", null, 
            ...
            return React.createElement("li", null, React.createElement("a", {href: "http://foundation.zurb.com/templates/portfolio-theme.html#", className: "button"}, menuItem));
        })
        ...
        React.createElement("div", {className: "hero"}, 
          React.createElement("div", {className: "row"}, 
            React.createElement("div", {className: "large-12 columns intro-text"}, 
              React.createElement("p", null, "Merhaba!", React.createElement("br", null), "I take outdoor pictures.")
            )
          )
        ), 
...
React.render(React.createElement(Top, null), document.getElementById('main'))
