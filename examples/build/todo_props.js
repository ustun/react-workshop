	...
	var TodoInput = React.createClass({
	  ...
	  render() {
	    return React.createElement(
	      ...
	      React.createElement("input", { id: "new-todo", placeholder: "test What needs to be done?", autofocus: true })
	    );
	  }
	});
	...
	var App = React.createClass({
	  ...
	  render() {
	    ...
	    return React.createElement(
	      "section",
	      { id: "todoapp" },
	      React.createElement(TodoInput, { name: "ustun" }),
	      React.createElement(TodoList, { tasks: todos }),
